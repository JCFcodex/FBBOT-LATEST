...
module.exports.config = {
  name: 'cosplay', // Command name
  version: '1.0.0', // Command version
  role: 0, // Permission level required (adjust as needed)
  credits: 'JC FAUSTINO', // Command author
  description: 'Sends a random picture of a cosplay to the group chat 🌸', // Brief description of what the command does
  commandCategory: 'General', // Category of the command
  usage: '[cosplay]', // Array of command usages
...
module.exports.run = async function({ api, event, args }) {
  try {
    ...
    const path = __dirname + '/cache/cosplay.png';
