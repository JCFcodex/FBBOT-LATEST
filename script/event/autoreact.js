...
const bot = []; // You may need to initialize it with appropriate values if needed
...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) {
  ...
  if (
    react &&
    (react.indexOf("love") == 0 ||
      react.indexOf("shet") == 0 ||
  ...
  if (
    react &&
    (react.indexOf("bobo") == 0 ||
      react.indexOf("gago") == 0 ||
      event.body.indexOf("gago") == 0 ||
      event.body.indexOf("Gago") == 0 ||
      ...
      event.body.indexOf("punyeta") == 0 ||
      (event.body.indexOf("haha") == 0 && !bot.includes(event.senderID)))
  ) {
    var msg = {
      body: "",
    };
